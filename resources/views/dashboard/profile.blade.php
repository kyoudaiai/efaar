        ...
        <div class="card">
            <div class="body">
                <ul class="nav nav-pills nav-pills-danger" role="tablist">
                    <li class="nav-item">
                        <a class="nav-link active" data-toggle="tab" href="#about" role="tablist" title="About">
                            <i class="zmdi zmdi-account"></i>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" data-toggle="tab" href="#security" role="tablist" title="Security">
                            <i class="zmdi zmdi-lock"></i>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" data-toggle="tab" href="#billing" role="tablist" title="Billing">
                            <i class="zmdi zmdi-money-box"></i>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" data-toggle="tab" href="#preferences" role="tablist" title="Account History">
            ...
            <div class="tab-content">
                ...
                <form id="profileform" action="{{route('dashboard.profile.update')}}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                    <div class="body">
                        <h6>Profile Photo</h6>
                        <div class="media photo ">
                            <div class="media-left m-r-15">
                                <img src="{{ ($user->profile && $user->profile->photo)? $user->profile->photo->getUrl('thumb') : asset('assets/images/avatar_male.png') }}" class="rounded-circle img-raised user-photo media-object">
                            </div>
                            <div class="media-body">
                                <p>Upload your photo.
                                    <br> <em>Image should be at least 140px x 140px. max file size: 2MB</em></p>
                                <button type="button" class="btn btn-default-dark btn-sm" id="btn-upload-photo">Upload Photo</button>
                                <input type="file" id="filePhoto" class="sr-only" name="photo">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="body">
                        ...
                        <div class="row clearfix">
                            <div class="col-lg-6 col-md-12">
                                ...
                                <input type="text" class="form-control" value="{{ ($user->profile) ? $user->profile->firstName : ''}}" placeholder="First Name" name="firstName" required>
                                </div>
                                <div class="form-group">
                                    <input type="text" class="form-control" value="{{($user->profile)?$user->profile->lastName : ''}}" placeholder="Last Name" name="lastName" required>
                                </div>
                                <div class="form-group">
                                    <div>
                                        <label class="fancy-radio">
                                            <input name="gender" value="male" type="radio" {{ ($user->profile && $user->profile->gender === 'male') ? 'checked' : ''}}>
                                            <span><i class="zmdi zmdi-male"></i> Male</span>
                                        </label>
                                        <label class="fancy-radio">
                                            <input name="gender" value="female" type="radio" {{ ($user->profile && $user->profile->gender === 'female') ? 'checked': ''}}>
                                            <span><i class="zmdi zmdi-female"></i> Female</span>
                                        </label>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="input-group masked-input">
                                        ...
                                        <input type="text" class="form-control date" placeholder="Birth date Ex: 1980-12-01 " value="{{($user->profile)?$user->profile->birthdate : ''}}" name="birthdate" required>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <input type="text" class="form-control" placeholder="website ..." name="website" value="{{($user->profile)?$user->profile->website : ''}}">
                                </div>
                            </div>
                            <div class="col-lg-6 col-md-12">
                                <div class="form-group">
                                    <input type="text" class="form-control" placeholder="Address Line 1" name="address1" required value="{{($user->profile)?$user->profile->address1 : ''}}">
                                </div>
                                <div class="form-group">
                                    <input type="text" class="form-control" placeholder="Address Line 2" name="address2" value="{{($user->profile)?$user->profile->address2 : ''}}">
                                </div>
                                <div class="form-group">
                                    <input type="text" class="form-control" placeholder="City" name="city" required value="{{($user->profile)?$user->profile->city : ''}}">
                                </div>
                                <div class="form-group">
                                    <input type="text" class="form-control" placeholder="State/Province" name="state" value="{{($user->profile)?$user->profile->state : ''}}">
                                </div>
                                <div class="form-group">
                                    <select class="form-control show-tick ms search-select" data-placeholder="Select" name="country" required>
                                        {!! ($user->profile && $user->profile->country)? '<option value="'.$user->profile->country.'" selected>'.$user->profile->country.'</option>' : ''!!}
                    ...
                    <div class="body">
                        ...
                        <div class="row">
                            <div class="col-lg-6 col-md-12">
                                ...
                                <input type="text" class="form-control mobile-phone-number" placeholder="Phone Number" name="phoneNumber" required value="{{($user->profile)?$user->profile->phoneNumber : ''}}">
                                </div>
                                <div class="form-group">
                                    <select class="form-control show-tick ms search-select" data-placeholder="Select" name="language" >
                                        {!! ($user->profile && $user->profile->language)? '<option value="'.$user->profile->language.'" selected>'.$user->profile->language.'</option>' : ''!!}
                                ...
                                <div class="form-group">
                                    <select class="form-control show-tick ms search-select" data-placeholder="Select" name="timezone">
                                        {!! ($user->profile && $user->profile->timezone)? '<option value="'.$user->profile->timezone.'" selected>'.$user->profile->timezone.'</option>' : ''!!}
                                ...
                                <ul class="list-unstyled list-email-received">
                                    <li>
                                        <label class="fancy-checkbox">
                                            <input type="checkbox" name="emailPermission" value="1" {{($user->profile && $user->profile->emailPermission == 1)? 'checked' : ''}}> <span> E-mails: Newsletters & Promotional offers</span></label>
                                    </li>
                                    <li>
                                        <label class="fancy-checkbox">
                                            <input type="checkbox" name="smsPermission" value="1" {{($user->profile && $user->profile->smsPermission == 1)? 'checked' : ''}}> <span> Text Messages: Notifications, Newsletters & Promotional offers</span></label>
                                    </li>
                                </ul>
                            </div>
                        </div>
                        ...
                        <div class="row clearfix">
                            <div class="col-lg-12 col-md-12 col-sm-12">
                                <div class="custom-control custom-switch custom-control-inline">
                                    ...
                                    <input type="checkbox" class="custom-control-input" id="auth2fa" name="auth2fa"
                                    {{ (!$user->google2fa_secret) ? ' disabled' : '' }}
                                    {{ ($user->auth2fa) ? ' checked' : '' }}
                                    >
                                    <label class="custom-control-label mr-1" for="auth2fa"></label>
                                    <span class="switch-label">Enable 2FA Authentication</span>

                                </div>
                                <div class="mb-5">
                                    {!! (!$user->google2fa_secret) ? '<small>To enable 2FA please setup your authenticator first</small>' : '' !!}
                                    <a href="{{route('2fa.reauth')}}" class="btn btn-danger"><i class="zmdi zmdi-lock"></i> {!! (!$user->google2fa_secret) ? 'Setup Authenticator' : 'Reset Authenticator' !!}</a>
                                </div>
                            </div>
