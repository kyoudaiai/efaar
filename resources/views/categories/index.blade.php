                        ...
                        <tbody>
                            @foreach($categories as $category)
                                ...
                                <td> {{ $category->name }} <span class="badge badge-info">{{ $category->posts->count() }}</span></td>
                                    <td>
                                        <a href="{{ route('categories.edit', $category->id) }}" class="btn btn-info waves-effect waves-float btn-sm waves-green"><i class="zmdi zmdi-edit"></i></a>
                                        <span onClick="handleDelete({{ $category->id }})" class="btn btn-danger waves-effect waves-float btn-sm waves-red"><i class="zmdi zmdi-delete"></i></span>
                                    </td>
                                </tr>
                            @endforeach
                        </tbody>
...
function handleDelete (id) {
    ...
    form.action = '/dashboard/blog/categories/' + id
